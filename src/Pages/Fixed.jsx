        ...
        >
          <div className="h-[100%] lg:w-[50%]">
            ...
            <ul className="list-decimal list-inside text-gray-600 2xl:text-xl">
              <li>Robust, weather-resistant materials</li>
              <li>Minimal maintenance with high durability</li>
              <li>Continuous protection from the elements</li>
              <li>Aesthetic appeal with a contemporary design</li>
              <li>
                Up to 40% reduction in heat, making your outdoor spaces more
                comfortable even in the intense UAE summer heat
              </li>
            </ul>
          </div>
          {!isMobile && (
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://img.freepik.com/free-photo/window-blinds_93675-130627.jpg?uid=R112225553&ga=GA1.1.2079436003.1694496204&semt=ais_hybrid)",
