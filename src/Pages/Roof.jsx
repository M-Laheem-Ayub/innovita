        ...
        >
          <div className="h-[100%] lg:w-[50%]">
            ...
            <ul className="list-decimal list-inside text-gray-600 2xl:text-xl">
              <li>Instant sun protection and shelter</li>
              <li>High-tech motorized options for convenience</li>
              <li>High durability for all weather conditions</li>
              <li>
                Reduces heat by up to 40%, allowing you to enjoy your outdoor
                space even in the peak heat of the UAE summer
              </li>
              <li>Perfect for residential and commercial spaces</li>
            </ul>
          </div>
          {!isMobile && (
            <div
              ...
              style={{
                backgroundImage:
                  "url(https://img.freepik.com/free-photo/vertical-low-angle-closeup-shot-black-roof-building_181624-10654.jpg?uid=R112225553&ga=GA1.1.2079436003.1694496204&semt=ais_hybrid)",
