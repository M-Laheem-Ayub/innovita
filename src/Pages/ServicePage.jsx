...
function Outdoor() {
  ...
  return (
    <div>
      ...
      <div className="w-screen lg:h-72 2xl:h-96 h-[50vh] flex justify-center relative z-20 mb-20">
        <div
          className={`w-2/3 h-[100%] flex flex-col-reverse mt-12 gap-20 lg:flex-row bg-white rounded-2xl lg:p-5 ${
            !isMobile ? "absolute -top-28 2xl:-top-[9rem]" : "relative"
          }`}
        >
          <div className="h-[100%] lg:w-[50%]">
            ...
            <ul className="list-decimal list-inside text-gray-600 2xl:text-2xl">
              <li>Outdoor Shading Solutions</li>
              <li>Aluminum Pergolas and Canopies</li>
              <li>Motorized Screens and Blinds</li>
              <li>Fixed Louver Pergolas</li>
              <li>Car Parking Sheds</li>
              <li>Custom Designs for Commercial and Residential Spaces</li>
            </ul>
          </div>
          {!isMobile && (
            <div
